<div class="mt-0 tab-pane fade show active" id="dashboard" role="tabpanel" aria-labelledby="setting-tab">
    <div class="mb-2 card" >
        <div class="card-body">
            ...
            <div class="p-3 mb-4 card">
                <h4>Add logo</h4>
                <p>Add a logo to help your Page standout and grow brand awareness.<a href="" class="text-decoration-none fw-bold">Add</a></p>
            </div>
            <div class="p-3 mb-4 card ">
                <h4>Add logo</h4>
                <p>Add a logo to help your Page standout and grow brand awareness.<a href="" class="text-decoration-none fw-bold">Add</a></p>
  ...
  <div class="row">
    <div class="mt-0" id="setting" role="tabpanel" aria-labelledby="setting-tab">
