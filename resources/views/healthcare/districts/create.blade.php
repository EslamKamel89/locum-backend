                ...
                <div class="row">
                    <div class="col-sm-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="districtName" name="name" placeholder="District name Here">
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-6">
                        <div class="form-group">
                            <label for="districtName" class="control-label col-form-label">State</label>
