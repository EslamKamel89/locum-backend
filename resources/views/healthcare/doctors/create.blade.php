                ...
                <div class="row">
                    <div class="col-sm-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input value="{{ old('professional_license_number') }}" type="text" class="form-control"
                                id="professional_license_number" name="professional_license_number"
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input value="{{ old('license_expiry_date') }}" type="date" class="form-control"
                                id="license_expiry_date" name="license_expiry_date" placeholder="license expiry date">
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-6">
                        <div class="form-group">
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input value="{{ old('cv') }}" type="file" class="form-control" id="cv" name="cv"
                                placeholder="cv">
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-6">
