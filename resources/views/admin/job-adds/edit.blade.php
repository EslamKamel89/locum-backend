                ...
                <div class="row">
                    <div class="col-sm-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input value="{{ $jobAdd->title }}" type="text" class="form-control" id="title" name="title"
                                placeholder="Title">
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="speciality_id" name="speciality_id">
                                ...
                                @foreach ($specialties as $speciality)
                                    <option value="{{ $speciality->id }}" {{ $jobAdd->speciality_id === $speciality->id ? 'selected' : '' }}>{{ $speciality->name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="job_info_id" name="job_info_id">
                                ...
                                @foreach ($jobInfos as $jobInfo)
                                    <option value="{{ $jobInfo->id }}" {{ $jobAdd->job_info_id === $jobInfo->id ? 'selected' : '' }}>{{ $jobInfo->name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input value="{{ $jobAdd->job_type }}" type="text" class="form-control" id="job_type" name="job_type"
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input value="{{ $jobAdd->location }}" type="text" class="form-control" id="location" name="location"
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input value="{{ $jobAdd->salary_min }}" type="number" class="form-control" id="salary_min" name="salary_min"
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input value="{{ $jobAdd->salary_max }}" type="number" class="form-control" id="salary_max" name="salary_max"
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input value="{{ $jobAdd->working_hours }}" type="text" class="form-control" id="working_hours" name="working_hours"
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input value="{{ $jobAdd->application_deadline }}" type="datetime-local" class="form-control" id="application_deadline" name="application_deadline"
