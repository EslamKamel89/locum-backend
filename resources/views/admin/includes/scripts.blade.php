...
<script src="{{ asset('dashboard/assets/libs/chartist-plugin-tooltips/dist/chartist-plugin-tooltip.min.js') }}">
</script>
<!--c3 charts -->
...
<script src="{{ asset('dashboard/assets/libs/jquery-validation/dist/jquery.validate.min.js') }}"></script>
