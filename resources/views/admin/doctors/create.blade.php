                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input value="{{ old('professional_license_number') }}" type="text"
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input value="{{ old('license_state') }}" type="text" class="form-control"
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group">
                                <label for="license_issue_date" class="control-label col-form-label">license issue
                                    date</label>
                                <input value="{{ old('license_issue_date') }}" type="date" class="form-control"
                                    id="license_issue_date" name="license_issue_date" placeholder="license issue date">
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group">
                                <label for="license_expiry_date" class="control-label col-form-label">license expiry
                                    date</label>
                                <input value="{{ old('license_expiry_date') }}" type="date" class="form-control"
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input value="{{ old('highest_degree') }}" type="text" class="form-control"
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input value="{{ old('field_of_study') }}" type="text" class="form-control"
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input value="{{ old('graduation_year') }}" type="number" class="form-control"
                                    id="graduation_year" name="graduation_year" placeholder="graduation year">
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group">
                                <label for="work_experience" class="control-label col-form-label">work experience</label>
                                <input value="{{ old('work_experience') }}" type="text" class="form-control"
                        ...
                        <div class="col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" placeholder="biography" rows="5" name="biography" id="biography">{{ old('biography') }}</textarea>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                <div id="repeater-list" class="mt-2">
                                    <div class="repeater-item mb-2">
                                        <div class="input-group">
                                            <input type="text" class="form-control" name="documents[0][document_name]" placeholder="Document Name" />
                                            <input type="text" class="form-control" name="documents[0][document_type]" placeholder="Document Type" />
