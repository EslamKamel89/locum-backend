                    ...
                    <div class="row">
                                ...
                                <select class="form-control" id="gender" name="gender">
                                    ...
                                    @foreach ($genders as $gender)
                                        <option value="{{ $gender->name }}"
                                            {{ $doctor->gender->name === $gender->name ? 'selected' : '' }}>
                                            {{ $gender->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input value="{{ $doctor->phone }}" type="text" class="form-control" id="phone"
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input value="{{ $doctor->date_of_birth->toDateString() }}" type="date"
                                    class="form-control" id="date_of_birth" name="date_of_birth" placeholder="birth day">
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group">
                                ...
                                <select class="" id="state_id" name="state_id">
                                    ...
                                    @foreach ($states as $state)
                                        <option value="{{ $state->id }}"
                                            {{ $doctor->user->state_id === $state->id ? 'selected' : '' }}>
                                            {{ $state->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                                ...
                                <select class="" id="district_id" name="district_id">
                                    ...
                                    @foreach ($districts as $district)
                                        <option value="{{ $district->id }}"
                                            {{ $doctor->user->district_id === $district->id ? 'selected' : '' }}>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input value="{{ $doctor?->doctorInfo?->professional_license_number }}" type="text"
                                    class="form-control" id="professional_license_number"
                                    name="professional_license_number" placeholder="professional license number">
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group">
                                <label for="license_state" class="control-label col-form-label">license state</label>
                                <input value="{{ $doctor?->doctorInfo?->license_state }}" type="text"
                                    class="form-control" id="license_state" name="license_state"
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group">
                                <label for="license_issue_date" class="control-label col-form-label">license issue
                                    date</label>
                                <input value="{{ $doctor?->doctorInfo?->license_issue_date?->toDateString() }}"
                                    type="date" class="form-control" id="license_issue_date"
                                    name="license_issue_date" placeholder="license issue date">
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group">
                                <label for="license_expiry_date" class="control-label col-form-label">license expiry
                                    date</label>
                                <input value="{{ $doctor?->doctorInfo?->license_expiry_date?->toDateString() }}"
                                    type="date" class="form-control" id="license_expiry_date"
                                    name="license_expiry_date" placeholder="license expiry date">
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group">
                                <label for="highest_degree" class="control-label col-form-label">highest degree</label>
                                <input value="{{ $doctor?->doctorInfo?->highest_degree }}" type="text"
                                    class="form-control" id="highest_degree" name="highest_degree"
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input value="{{ $doctor?->doctorInfo?->field_of_study }}" type="text"
                                    class="form-control" id="field_of_study" name="field_of_study"
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input value="{{ $doctor?->doctorInfo?->work_experience }}" type="text"
                                    class="form-control" id="work_experience" name="work_experience"
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input value="{{ $doctor?->doctorInfo?->cv }}" type="file" class="form-control"
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group">
                                ...
                                <select class="my-select" multiple="multiple" style="height: 36px;width: 100%;"
                                    id="skills" name="skills[]">
                                    <option value="">Select Skills</option>
                                    @foreach ($skills as $skill)
                                        <option value="{{ $skill->name }}"
                                            {{ $doctor->skills->contains($skill->id) ? 'selected' : '' }}>
                                            {{ $skill->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                                ...
                                <select class="my-select" multiple="multiple" style="height: 36px;width: 100%;"
                                    ...
                                    @foreach ($langs as $lang)
                                        <option value="{{ $lang->name }}"
                                            {{ $doctor->langs->contains($lang->id) ? 'selected' : '' }}>
                                            {{ $lang->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                                ...
                                <select class="" id="job_info_name" name="job_info_name">
                                    ...
                                    @foreach ($jobInfos as $job)
                                        <option value="{{ $job->name }}"
                                            {{ $doctor->job_info_id === $job->id ? 'selected' : '' }}>{{ $job->name }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group">
                                <label for="shift_preference" class="control-label col-form-label">shift
                                    preference</label>
                                <select class="form-control" id="shift_preference" name="shift_preference">
                                    ...
                                    @foreach ($shiftPreferences as $shift)
                                        <option value="{{ $shift->name }}"
                                            {{ $doctor->shift_preference === $shift->name ? 'selected' : '' }}>
                                            {{ $shift->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                                ...
                                <select class="" id="university_name" name="university_name">
                                    ...
                                    @foreach ($universities as $university)
                                        <option value="{{ $university->id }}"
                                            {{ $doctor?->doctorInfo?->university_id === $university->id ? 'selected' : '' }}>
                                            {{ $university->name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" placeholder="biography" rows="5" name="biography" id="biography">{{ $doctor?->doctorInfo?->biography }}</textarea>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-12">
                            <div class="form-group">
                        ...
                        <div class="col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                <div id="repeater-list" class="mt-2">
                                    @foreach ($doctor->doctorDocuments as $index => $document)
                                ...
                                <button type="button" id="add-item" class="btn btn-success mt-2">Add Document</button>
                                <script>
                                    // تعريف repeaterList بعد تحميل الصفحة
                                    const repeaterList = document.getElementById('repeater-list');

                                    // إضافة عنصر جديد عند الضغط على الزر "Add Document"
                                    ...
                                    // إزالة العنصر عند الضغط على زر الحذف
